...
exports.get = (req, res) => {
  ...
  Version.findById(id).then(
    version => tools.responseSuccess(res, version),
...
exports.getAllByProductId = (req, res) => {
  ...
  Version.find({
    ...
    versions => tools.responseSuccess(res, versions),
    err => tools.responseFailure(res, err)
  );
};
...
exports.create = (req, res) => {
  ...
  Version.create(createVersion(name, product)).then(
    version => tools.responseSuccess(res, version),
    err => tools.responseFailure(res, err)
  );
};
...
exports.update = (req, res) => {
  ...
  Version.findByIdAndUpdate(id, { name, updateAt, mark }).then(
    version => tools.responseSuccess(res, version),
    err => tools.responseFailure(res, err)
  );
};
...
exports.del = (req, res) => {
  ...
  Version.findByIdAndRemove(id).then(
    version => tools.responseSuccess(res, version),
    err => tools.responseFailure(res, err)
  );
};
